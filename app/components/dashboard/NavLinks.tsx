...
const links = [
  ...
  { name: 'Department', href: '/dashboard/department', icon: DocumentDuplicateIcon },
  { name: 'Results', href: '/dashboard/result', icon: UserGroupIcon },
  { name: 'Rank', href: '/dashboard/rank', icon: UserGroupIcon },
];
